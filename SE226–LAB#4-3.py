...
for i in range(8):
    ...
    while not user_number.isdigit() or int(user_number) not in range(3, 8):
        user_number = input("Invalid input. Number must be between 3 and 7: ")

    passwordWords = random.sample(words, int(user_number))
